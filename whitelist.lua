...
local serverData = game:HttpGet("http://localhost/checkWhitelist?Key=" .. Key .. "&gamer=" .. Random); 
local predictedData = hmac(secretKey2, Key .. Random);

print(serverData) 
if(serverData == predictedData) then
   loadstring(game:HttpGet("https://raw.githubusercontent.com/yusufupvpytt/astralhub/master/astralhubloader.lua", true))()
else
